...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.lstm = nn.LSTM(config.hidden_size, config.rnn_hidden, config.num_layers, batch_first=True, dropout=config.dropout, bidirectional=True)#最后一个参数第71课5分50
